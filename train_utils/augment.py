...
# Coefficients of various wavelet decomposition low-pass filters from official implementation used

# Load wavelets from JSON file
def load_wavelets_from_json(filename='wavelets.json'):
    with open(filename, 'r') as f:
        wavelets = json.load(f)
    print(f"Wavelets loaded from {filename}")
    return wavelets

# Load wavelets
wavelets = load_wavelets_from_json()
